...
import { mockCompany, mockKPIs, mockMarketData, mockFilings, mockEarnings } from "@/lib/mock-data";
...
export default function DemoPage() {
  ...
  // Data Forward Dashboard component structure
  const components = [
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 mt-2">
              This is a demo of the Data Forward Dashboard template. Template provided by Beacon IR.
            </p>
          </div>
        </div>
      </footer>
